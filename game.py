...
class Game(object):
    def __init__(self):
        ...
        self.menu = Menu(("Start","Info & Tutorial","Exit"),font_color = WHITE,font_size=60)
        # Create the player
    ...
    def display_frame(self,screen):
        ...
        if self.game_over:
            if self.about:
                self.display_message(screen,"By RyzenK8. How to play pymac use arrow keys")
                #"a maze containing various dots,\n"
                #known as Pac-Dots, and four ghosts.\n"
                #"The four ghosts roam the maze, trying to kill Pymac.\n"
